...
class PacmanDQN(game.Agent):
    ...
    def getImageFromState(self, state):
        ...
        if state.getGhostState(1).scaredTimer != 0:
            im.putpixel((int(state.getGhostPosition(1)[0]), int(state.getGhostPosition(1)[1])), ImageColor.getrgb("rgb(166, 166, 166)"))
        else:
        ...
        #     im.putpixel((int(state.getGhostPosition(2)[0]), int(state.getGhostPosition(2)[1])), ImageColor.getrgb("rgb(166, 166, 166)"))
        # else:
        #     im.putpixel((int(state.getGhostPosition(2)[0]), int(state.getGhostPosition(2)[1])), ImageColor.getrgb("rgb(255, 0, 255)"))
            ...
            if np.random.rand() > self.params['eps']:
                ...
                self.Q_pred = self.qnet.sess.run(
                    ...
                    feed_dict = {self.qnet.x: np.reshape(image,
                                                       (1, params['augmentation']*params['width'], params['augmentation']*params['height'], 3)), 
